...
int main() {
    ...
    my_drone.drone_id = 101;
    my_drone.lat = 34.0500;    // Starting Latitude (e.g., Los Angeles)
    my_drone.lon = -118.2500;  // Starting Longitude
    my_drone.alt = 150.0;      // 150 meters
    my_drone.vx = 0.0001; // Moving North
    my_drone.vy = 0.0001; // Moving East
